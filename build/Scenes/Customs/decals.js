var CreateDecalsTestScene = function (engine) {
	...
	BABYLON.SceneLoader.ImportMesh("Shcroendiger'scat", "scenes/assets/", "SSAOcat.babylon", scene, function (newMeshes) {
		var cat = newMeshes[0];
		...
		decalMaterial.diffuseTexture = new BABYLON.Texture("/Scenes/Assets/impact.png", scene);
