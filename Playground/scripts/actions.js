...
var prepareButton = function(mesh, color, light) {
    ...
    mesh.actionManager.registerAction(new BABYLON.InterpolateValueAction(BABYLON.ActionManager.OnPickTrigger, light, "diffuse", BABYLON.Color3.Black(), 1000))
        .then(new BABYLON.CombineAction(BABYLON.ActionManager.NoneTrigger, [
// Then is used to add a child action used alternatively with the root action. 
            ...
            new BABYLON.SetValueAction(BABYLON.ActionManager.NoneTrigger, mesh.material, "wireframe", false)
        ]));
...
var condition2 = new BABYLON.StateCondition(sphere.actionManager, light1, "diffuse", BABYLON.Color3.Black(), BABYLON.StateCondition.IsEqual);
...
sphere.actionManager.registerAction(new BABYLON.InterpolateValueAction(BABYLON.ActionManager.OnPickTrigger, camera, "alpha", Math.PI, 500, condition2));
